  ...
  return (
    <div className='h-screen lg:flex bg-black text-white '>
     <form onSubmit={(e)=>{
      ...
      <input type="text" placeholder='Enter Notes Heading' className='px-5 text-black w-full font-medium py-2 border-2 outline-none rounded' value={title} onChange={(e)=>{
      setTitle(e.target.value);
      }}/>

      <textarea type="text" 
      className="px-5 w-full font-medium h-32 py-2 flex items-start flex-row text-black border-2 outline-none roundsed"
