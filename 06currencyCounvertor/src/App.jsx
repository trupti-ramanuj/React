...
const convert = () => {
    setCon(amount * currencyInfo[to])
}
  return (
    <>
<div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat' style={{backgroundImage:`url('https://images.pexels.com/photos/3532540/pexels-photo-3532540.jpeg')`,}}>
  <div className='w-full'>
    ...
    <form onSubmit={(e) => {
      ...
      <div className='w-full mb-1'>
        ...
        selectCurrency={from}
        onAmountChange={(amount) => setAmount(amount)} /></div>
